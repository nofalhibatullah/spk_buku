...
use App\Models\datanormalisasibobot_model;
use App\Models\namajenis_model;
...
class Home extends BaseController
{
    ...
    public function callviewjenisbuku()
    {
        ...
        echo View('admin_header');
        echo View('admin_nav');
        echo View ('viewjenisbuku',$data); 
        echo View('admin_footer');
    }
    public function callviewdatabuku()
    {
        $mb = new databuku_model();
    ...
    public function callviewnormalisasibobot()
    {
        
        $mb = new datanormalisasibobot_model();
        $datamb = $mb->tampilnormalisasibobot();
        $data = array('dataMb'=> $datamb);
