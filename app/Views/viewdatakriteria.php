          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Kriteria Buku</h3>
              </div>
              <!-- /.card-header -->
              ...
              <!-- <button type="button" class="btn btn-success" onclick="window.location='<?php echo site_url('home/formtambah'); ?>'">Tambah Kriteria </button> -->
                ...
                <tr>
                    ...
                    <!-- <td> -->
                    <!-- <a href="/home/formeditmbl/<?=$row->id_kriteria;?>" class="badge badge-primary">Edit</a>   -->
                    <!-- <a href="/home/deletembl/<?=$row->id_kriteria;?>" class="badge badge-danger">hps</a> -->
